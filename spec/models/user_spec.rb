...
describe User do
  ...
  #verify that lenght validation exists for the name fields
  describe "when name is too long" do
    before { @user.name = "a" * 51 }
    it { should_not be_valid }
  end

  #verify that email format validation exists for the email fields
  ...
  #verify that validation exists for duplicate emails
  describe "when email address is already taken" do
    before do
      user_with_same_email = @user.dup
      user_with_same_email.email = @user.email.upcase  #emails are not case sensitive
